...
class Museum : KSpigot() {
    ...
    override fun startup() {
        ...
        fun getNavigatorGui(mafia: Boolean): GUI<ForInventoryFourByNine> {
                ...
                page(1) {
                    ...
                    val mafiaSurvivalIcon = itemStack(Material.OAK_BOAT) {
                        meta {
                            ...
                            addLore {
                                +literalText("November 21st 2020 to December 8th 2021") {
                                    color = TextColor.color(255, 184, 184)
                                    italic = false
                                }
                                +literalText(" ")
        ...
        val nonMafiaGui = getNavigatorGui(false)
        val mafiaGui = getNavigatorGui(true)
        ...
        listen<PlayerInteractEvent> {
            if (it.item?.type == Material.RECOVERY_COMPASS) {
                ...
                if (it.player.scoreboardTags.contains("mafia")) {
                    it.player.openGUI(mafiaGui)
                } else {
                    it.player.openGUI(nonMafiaGui)
                }
            }
